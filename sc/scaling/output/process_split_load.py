...
Tc = 0.684   # increasing Tc makes higher fields curves' bell "less wide", increasing Tc+decreasing gamma seems good
delta = 6.9  # increasing delta shifts lower fields to lower values
...
# 0.69, 6.0, 1.29 seems the best combination so far
