...
#     kiTxy = ki_fluctTxy[2] # dataset is slightly different as it includes H=3,3.1 too, so index is 6 here, rather than 4.
#     HTxy = HsTxy[2]
...
#     plt.title("Scaling function - fluct - H=2 - δ={}, γ + β={}".format(delta, gamma+beta))
#     plt.xlabel("εˠ⁺ᵝ/H")
#     plt.ylabel("χ/H^(1/̣δ-1)")
# #    plt.xlim(1e-3, 1e1)
# #    plt.ylim(0, 0.25)
...
#     plt.show()
    ...
    plt.xscale("log")
    #plt.title("Tc={:.3f}, δ={}, γ + β={}".format(Tc, delta, gamma+ beta))
    plt.title("Scaling function - diff - H=2 - δ={}, γ + β={}".format(delta, gamma+beta))
    plt.xlabel("εˠ⁺ᵝ/H")
    plt.ylabel("χ/H^(1/̣δ-1)")
#    plt.xlim(1e-3, 1e1)
#    plt.ylim(0, 0.25)
