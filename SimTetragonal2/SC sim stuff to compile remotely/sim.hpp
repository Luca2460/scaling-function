...
class Sim
{
public: //edit below added Jz
    Sim(size_t N, size_t Nmeasure, double Nthermal, double stride
	, std::string const& filename, double temperature, double kb, double J, double Jz, double Jxy
...
private:
    ...
    double _J;
    double _Jz; // differential scaling for spins in the same plane/different planes
    double _Jxy;
    Vec _H;
