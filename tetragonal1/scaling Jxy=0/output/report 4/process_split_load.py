...
Tc = 0.1251
delta = 30.0  # increasing delta shifts lower fields to lower values
gamma = 1.08 # increasing gamma or beta (only their sum matters) shifts low fields to higher values before the peak
             # and lower values after the peak (worse)
beta = 0.0
